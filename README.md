...
[![GH-release](https://img.shields.io/badge/version-2.3.0-red.svg?style=flat-square)](https://raw.githubusercontent.com/benct/lovelace-xiaomi-vacuum-card/master/xiaomi-vacuum-card.js)
...
```yaml
resources:
  - url: /local/xiaomi-vacuum-card.js?v=2.3.0
    type: js
```
...
| Name | Type | Default | Description
| ---- | ---- | ------- | -----------
| vendor | string | `xiaomi` | Supported vendors: `xiaomi`, `valetudo`, `ecovacs`, `ecovacs_ozmo`
