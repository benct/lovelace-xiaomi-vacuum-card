...
[![GH-release](https://img.shields.io/badge/version-2.3.1-red.svg?style=flat-square)](https://raw.githubusercontent.com/benct/lovelace-xiaomi-vacuum-card/master/xiaomi-vacuum-card.js)
...
```yaml
resources:
  - url: /local/xiaomi-vacuum-card.js?v=2.3.1
    type: js
```
